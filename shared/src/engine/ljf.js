...
exports.runLJF = runLJF;
var utils_js_1 = require('./utils.js');
function runLJF(inputProcesses, options) {
  if (options === void 0) {
    options = {};
  }
  ...
  while (completedCount < totalProcesses) {
    ...
    // 2. Select longest burst for available cores
    ...
    for (var _i = 0, cores_1 = cores; _i < cores_1.length; _i++) {
      ...
      if (core.currentTime <= systemTime && readyQueue.length > 0) {
        readyQueue.sort(function (a, b) {
          if (a.burst !== b.burst) return b.burst - a.burst; // Longest first
          return a.arrival - b.arrival;
        });
        ...
        logDecision(
          ...
          'Selected '
            .concat(currentProcess.pid, ' because it has the longest burst time (')
