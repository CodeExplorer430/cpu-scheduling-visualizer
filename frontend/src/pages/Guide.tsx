        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              ...
              <PlusIcon className="w-4 h-4 inline" /> <strong>Add Process</strong> button to create
              new rows.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded text-sm text-blue-800 dark:text-blue-300 border border-blue-100 dark:border-blue-800">
              <strong>Tip:</strong> For Round Robin, click "Optimize" to let Quantix find the best
              Time Quantum for your process set!
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Once you click <PlayIcon className="w-4 h-4 inline" /> <strong>Run Simulation</strong>
              , use the <strong>Time Control</strong> slider or buttons to step through execution.
            </p>
            <p className="text-gray-600 dark:text-gray-400">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Logged-in users can <strong>Save</strong> and <strong>Load</strong> scenarios using
              the cloud buttons at the top of the process table. Never lose your test cases again!
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="col-span-2 space-y-4">
              <p className="text-gray-700 dark:text-gray-300">
                The <strong>Compare</strong> page allows you to evaluate all supported algorithms
                simultaneously on the exact same dataset.
              </p>
              <ul className="space-y-3">
                <li className="flex gap-2">
                  <span className="text-purple-600 font-bold">•</span>
                  <span>
                    <strong>Visual Stack:</strong> View multiple Gantt charts stacked vertically,
                ...
                <li className="flex gap-2">
                  <span className="text-purple-600 font-bold">•</span>
                  <span>
                    <strong>Metrics Table:</strong> Compare Average Waiting Time, Turnaround Time,
                    and Context Switches in a single table.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-purple-600 font-bold">•</span>
                  <span>
                    ...
                    <strong>PNG</strong> or <strong>PDF</strong> for assignments or documentation.
                  </span>
                </li>
              </ul>
            </div>
